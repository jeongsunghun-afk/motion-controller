        ...
        while True:
            ...
            # ── FORCE_J_IDLE (Mode A — Joint impedance + 옵션 A) ──────────
                ...
                if not self._force_j_active:
                    ...
                    self._mcx.set_pos_and_torque(q_cmd, tau)
                    with self._lock:
